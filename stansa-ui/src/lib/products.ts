...
export const PRODUCTS: Product[] = [
  ...
  { slug: 'losacero_fortadeck',           name: 'Losacero',                     category: 'láminas',    tagline: 'Lámina galvanizada para losa acero-concreto.',           surface: 'metal-surface--warm',  image: '/products/losacero.webp' },
